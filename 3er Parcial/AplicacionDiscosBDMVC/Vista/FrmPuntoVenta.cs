...
namespace Vista
{
    public partial class FrmPuntoVenta : Form
    {
        ...
        public void CargarDatos()
        {
            ...
            ClienteMgr objClienteMgr = new ClienteMgr();
            try
            {
                //Cargamos los discos disponibles al ComboBox de Discos.
                cboDiscos.Items.AddRange(objDiscoMgr.ObtenerDiscosList().ToArray());
                //Cargamos los clientes disponibles al ComboBox de Clientes.
                cboCliente.Items.AddRange(objClienteMgr.ObtenerClientesList().ToArray());
            }
            catch (Exception ex)
            {
        ...
        {
            Form formulario = new ReportesVentas();
            formulario.Show();
        }
    }
}