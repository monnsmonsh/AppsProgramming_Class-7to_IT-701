...
namespace ProgramaPersonal_IT701
{
    class ProgramaPersona
    {
        static void Mainx(string[] args){
            ...
            objPersona.Telefono = "477-224-3750"; //Asignado el valor a telefono
            objPersona.Email = "itsktyu.mk@gmail.com"; //Asignado el valor a email
            objPersona.FechaNacimineto = Convert.ToDateTime("14/11/1995"); //Asignado el valor a fecha
